            ...
            child: SingleChildScrollView(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Verify Your Phone Number', style: setStyleContent(context,Colors.black,18,FontWeight.bold),),
                    Text('We have sent a verification code to your number',  style: setStyleContent(context,Colors.black,12,FontWeight.normal),),
                    Text('+234-8782-2154', style: setStyleContent(context,Colors.black,18,FontWeight.bold),),
                    ...
                    AppButton(text: 'Next', onPressed: (){
                      Navigator.push(context,MaterialPageRoute(builder: (context) => EmailVerificationIndexScreen()));
                    }),
                    NumericKeyboard(
