...
class  ManageCardState extends State <ManageCard> with SingleTickerProviderStateMixin {
  @override
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
            SizedBox(height: 15,),
          Text("MANAGE CARDS",style: setStyleContent(context,Colors.black,20,FontWeight.bold),),
          SizedBox(height: 25,),
          Container(
            height: 120,
            child: Column(
