...
class  ConnectedInstitution extends StatefulWidget{
  @override
  ConnectedInstitutionState createState() =>  ConnectedInstitutionState();
}

class  ConnectedInstitutionState extends State <ConnectedInstitution> with SingleTickerProviderStateMixin {
  @override
      ...
      body: SafeArea(
        child: Container(
          ...
          child: Column(
            ...
            children: [
            SizedBox(height: 15,),
          Text("CONNECTED INSTITUTION", style: GoogleFonts.poppins(textStyle: TextStyle(fontSize: 20, color: Colors.black, fontWeight: FontWeight.bold)),),
          SizedBox(height: 25,),
          Container(
            height: 100,
            child: Column(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  onTap: (){
                    Navigator.push(context,MaterialPageRoute(builder: (context) => TransferLimits()));
                  },
                )
              ],
            )
