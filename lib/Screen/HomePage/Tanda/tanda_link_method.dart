...
import 'package:tanda/Screen/HomePage/Tanda/tanda_credential_login.dart';
...
class  TandaLinkMethod extends StatefulWidget{
  @override
  TandaLinkMethodtate createState() =>  TandaLinkMethodtate();
}

class  TandaLinkMethodtate extends State <TandaLinkMethod>{
          ...
          child:  Column(
            ...
            children: [
              ...
              AppButton(text: 'Next', onPressed: (){
                Navigator.push(context,MaterialPageRoute(builder: (context) => TandaLoginCredentials()));
              }),
              SizedBox(height: 120,),
              Row(
