...
import 'package:tanda/Screen/Smart/goal_date.dart';
...
class SavingGoal extends StatefulWidget{
  @override
  SavingGoalState createState() => SavingGoalState();
}

class SavingGoalState extends State <SavingGoal>{
          ...
          child: SingleChildScrollView(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height:  2.0,),
                  Text('EDIT SAVING GOAL', style: setStyleContent(context,Colors.black,20,FontWeight.bold),),
                  SizedBox(height:ScreenUtil().setHeight(75.0)),
                  TextField(
                    keyboardType: TextInputType.emailAddress,
                    autofocus: false,
                    decoration: InputDecoration(
                      labelText: 'Old Saving Goal',
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  onTap: (){
                    Navigator.push(context,MaterialPageRoute(builder: (context) => GoalDate()));
                  },
                )
              ],
            )
