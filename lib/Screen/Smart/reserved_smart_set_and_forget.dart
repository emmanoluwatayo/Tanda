...
class ReservedSetAndForget extends StatefulWidget{
  @override
  ReservedSetAndForgetState createState() => ReservedSetAndForgetState();
}

class ReservedSetAndForgetState extends State <ReservedSetAndForget>{
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  onTap: (){
                    Navigator.push(context,MaterialPageRoute(builder: (context) => WeeklyReservedFund()));
                  },
                )
              ],
            )
