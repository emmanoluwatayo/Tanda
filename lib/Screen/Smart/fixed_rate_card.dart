...
import 'package:tanda/Screen/Smart/fixed_rate_newcard.dart';
import 'package:tanda/Screen/link_bank.dart';
import 'package:tanda/Signup/login.dart';
import 'package:tanda/homepage.dart';

class FixedRateCard extends StatefulWidget{
  @override
    FixedRateCardState createState() =>    FixedRateCardState();
}

class    FixedRateCardState extends State <  FixedRateCard> with SingleTickerProviderStateMixin {
  @override
        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
                ...
                children: [
                  SizedBox(height: 15,),
                  Text("PAY WITH DEBIT CARD",style: setStyleContent(context,Colors.black,20,FontWeight.bold),),
                  SizedBox(height: 25,),
                  Container(
                    height: 120,
                    child: Column(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  onTap: (){
                    Navigator.push(context,MaterialPageRoute(builder: (context) => FixedRateNewCard()));
                  },
                )
              ],
            )
