...
class SmartRule extends StatefulWidget{
  @override
  SmartRuleState createState() => SmartRuleState();
}

class SmartRuleState extends State <SmartRule>{
  @override
  ...
  roundup(BuildContext context) async {
    String teamName = '';
    return showDialog(
      context: context,
      barrierDismissible: false, // dialog is dismissible with a tap on the barrier
                ...
                Row(
                  ...
                  children: [
                    GestureDetector(
                      ...
                      onTap: (){
                        Navigator.push(context,MaterialPageRoute(builder: (context) => SmartRule()));
                      },
                    ),
                    GestureDetector(
                      child:  Container(
  ...
  payday(BuildContext context) async {
    String teamName = '';
    return showDialog(
      context: context,
      barrierDismissible: false, // dialog is dismissible with a tap on the barrier
  ...
  weeks(BuildContext context) async {
    String teamName = '';
    return showDialog(
      context: context,
      barrierDismissible: false, // dialog is dismissible with a tap on the barrier
