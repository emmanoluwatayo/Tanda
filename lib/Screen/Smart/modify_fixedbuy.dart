...
import 'package:tanda/Screen/Tanda_Balance/Tandabalance.dart';

class ModifyFixedRateWithdraw extends StatefulWidget{
  @override
  ModifyFixedRateWithdrawState createState() => ModifyFixedRateWithdrawState();
}

class ModifyFixedRateWithdrawState extends State <ModifyFixedRateWithdraw>{
  @override
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  onTap: (){
                    withrawcongratulations(context);
                  },
                )
              ],
            )
  ...
  withrawcongratulations(BuildContext context) async {
    String teamName = '';
    return showDialog(
        context: context,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      onTap: (){
                        Navigator.push(context,MaterialPageRoute(builder: (context) => TandaBalance()));
                      },
                    )
                  ],
                )
