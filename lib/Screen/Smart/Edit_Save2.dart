...
import 'package:tanda/Screen/Smart/set_and_forget_goal.dart';
...
class EditSaveGoal22 extends StatefulWidget{
  @override
  EditSaveGoal22State createState() => EditSaveGoal22State();
}

class EditSaveGoal22State extends State <EditSaveGoal22>{
  @override
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  onTap: (){
                    Navigator.push(context,MaterialPageRoute(builder: (context) => EditSetAndForget()));
                  },
                )
              ],
            )
