...
class FixedRate extends StatefulWidget{
  @override
  FixedRateState createState() => FixedRateState();
}

class FixedRateState extends State <FixedRate>{
  @override
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  onTap: (){
                    Navigator.push(context,MaterialPageRoute(builder: (context) => FixedRateBuy()));
                  },
                )
              ],
            )
