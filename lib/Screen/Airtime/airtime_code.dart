...
import 'package:tanda/Screen/Airtime/airtime_paybills.dart';
...
class AirtimePinCode extends StatefulWidget{
  @override
  AirtimePinCodeState createState() => AirtimePinCodeState();
}

class AirtimePinCodeState extends State <AirtimePinCode>{
  String text = '';
  ...
  airtimepincode(BuildContext context) async {
    String teamName = '';
    return showDialog(
        context: context,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      onTap: (){
                        Navigator.push(context,MaterialPageRoute(builder: (context) => AirtimePayBills()));
                      },
                    )
                  ],
                )
