...
class FirstTransfer extends StatefulWidget{
  @override
  FirstTransferState createState() => FirstTransferState();
}

class FirstTransferState extends State <FirstTransfer>{
  @override
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 2,),
                Text("YOUR FIRST TRANSFER", style: setStyleContent(context, ColorConstant.black, 20, FontWeight.bold),),
                Text("Make your first wallet top up", style: setStyleContent(context, ColorConstant.black, 12, FontWeight.normal),),
                Row(
                ...
                Container(
                  ...
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Make your first deposit today from your \nbank to your Tanda wallet" , style: setStyleContent(context, ColorConstant.primaryColor, 12, FontWeight.bold),),
                        SizedBox(height: 10,),
                        Text("Familiarize with the Tanda pay\nof the app" , style: setStyleContent(context, ColorConstant.primaryColor, 12, FontWeight.bold),),
                      ]),
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(12),
                  ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      onTap: (){
                        Navigator.push(context,MaterialPageRoute(builder: (context) => FirstTransfer()));
                      },
                    )
                  ],
                )
