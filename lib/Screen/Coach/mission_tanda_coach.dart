...
class MissionTandaCoach extends StatefulWidget{
  @override
  MissionTandaCoachState createState() => MissionTandaCoachState();
}

class MissionTandaCoachState extends State <MissionTandaCoach>{
  @override
        ...
        child: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Text("MISSION", style: setStyleContent(context, ColorConstant.black, 15, FontWeight.normal),),
                SizedBox(height: 2,),
                GestureDetector(
                  child: Container(
                    width: 330,
