...
class CompleteSweatitOut extends StatefulWidget{
  @override
  CompleteSweatitOutState createState() => CompleteSweatitOutState();
}

class CompleteSweatitOutState extends State <CompleteSweatitOut>{
  @override
